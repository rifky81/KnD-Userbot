...
async def amireallyalive(alive):
    ...
    sleep(1)
    await alive.edit("**Proses Menghidupkan** **K**")
    await alive.edit("**Proses Menghidupkan** **Kn**")
    await alive.edit("**Proses Menghidupkan** **KnD**")
    sleep(1)
    await alive.edit("**Proses Menghidupkan** **KnD U**")
    await alive.edit("**Proses Menghidupkan** **KnD Us**")
    await alive.edit("**Proses Menghidupkan** **KnD Use**")
    await alive.edit("**Proses Menghidupkan** **KnD User**")
    await alive.edit("**Proses Menghidupkan** **KnD Userb**")
    await alive.edit("**Proses Menghidupkan** **KnD Userbo**")
    await alive.edit("**Proses Menghidupkan** **KnD Userbot**")
    sleep(1)
    ...
    output = (
        ...
        f"📍 REPO [KnD USERBOT](https://github.com/rifky81/KnD-Userbot)\n")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
...
@register(outgoing=True, pattern=r"^\.(?:alive|KnD)\s?(.)?")       
async def amireallyalive(alive):       
    user = await bot.get_me()    
    await get_readable_time((time.time() - StartTime))    
    ...
    output = (   
        ...
        f"**╚═════════✹═════════╝** \n"
        f"👻 𝐎𝐰𝐧𝐞𝐫 : [Sentuh Aku](t.me/rifkyyyyyyyyyyyyyyyy) \n"
