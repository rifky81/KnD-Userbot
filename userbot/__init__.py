...
UPSTREAM_REPO_URL = (os.environ.get("UPSTREAM_REPO_URL")
                     or "https://github.com/rifky81/KnD-Userbot")
...
S_PACK_NAME = os.environ.get("S_PACK_NAME") or "KnD-Packs"
...
# Terminal Alias
TERM_ALIAS = os.environ.get("TERM_ALIAS") or "KnD Userbot"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "**KnD USERBOT › BERHASIL DIAKTIFKAN**")
    return
            ...
            if event.query.user_id == uid and query.startswith(""):
                ...
                result = builder.article(
                    ...
                    text="{}\nTotal loaded modules: {}".format(
                        "[KnDUserbot](https://github.com/rifky81/KnD-Userbot) modules helper.\n",
                        len(dugmeler),
                    ),
                    buttons=buttons,
                    link_preview=False,
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "GitHub Repo",
                                "https://github.com/rifky81/KnD-Userbot",
                            ),
                            custom.Button.url(
                                "Channel",
